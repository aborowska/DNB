...
//		DrawNuDiscreteDNB(sParam , iNumOfObs, gsl_random_num, 0.025,0.05);
		...
		// DrawNuInBlockDiscreteDNB(vData, sParam ,  iNumOfObs, gsl_random_num, 0.2,5);
		DrawNuInBlockDiscreteDNB(vData, sParam ,  iNumOfObs, gsl_random_num, 0.2,6);		

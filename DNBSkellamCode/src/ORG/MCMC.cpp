...
void MCMC::EstimateSkellam( int iNumOfIter, int iBurnIn)
{
	...
	sParam.dMu[0]=0;
	sParam.dPhi[0]=0.97;// KEEP TRUE!!!
	sParam.dSigma2[0]=0.02; // KEEP TRUE!!!
	// sParam.dGamma[0]=0.3;
	sParam.dGamma[0]=0.3;  
...
//  keep true!!! //			DrawPhiSigmaAdaptiveRWWithSeasonal( iNumOfKnots, mWTilde,sParam, iNumOfObs,  i , gsl_random_num,  mCovar,   mSum );
...
//		DrawXandMu(sParam,iNumOfObs, gsl_random_num );
		...
		printf ("Elasped time is %10.8f seconds. \n", dif );
